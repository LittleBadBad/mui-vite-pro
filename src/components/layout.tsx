...
import {
    AppBar, Box, CSSObject,
    Drawer,
    IconButton,
    ListItemButton, ListItemIcon, ListItemText, Theme,
    Toolbar,
    Typography,
    useTheme
} from "@mui/material";
...
import Tree, {RenderTree} from "@/components/tree";
...
const icon = "https://gw.alipayobjects.com/zos/rmsportal/KDpgvguMpGfqaHPjicRK.svg"
...
export default function Layout() {
    ...
    return <Box sx={{display: "flex", flexDirection: "column", backgroundColor: theme.palette.background.default}}>
        ...
        <Drawer variant={"permanent"} open={open}
            ...
            <Box sx={{padding: '0 12px', overflowX: 'hidden'}}>
                <Tree<MenuLink>
